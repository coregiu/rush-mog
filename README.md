# Rush Mog
Rush Mog是一款致敬Unimog的万向轮智能高扭矩小车。基于stm32f103 + L298N驱动车体，支持asrpro音频直接控制，ESP32实现手机WIFI的PS2控制，VLA控制三种模式，带语音聊天 + 机械臂操作的机器人。
...
#### （6）聊天
基于ESP32连网，实现Agent根据客户语音搜索知识并回答，同时提供记忆上下文能力，智能自演进。
